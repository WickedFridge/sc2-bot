...
class CycloneTank3Rax(BuildOrder):
    name: BuildOrderName = BuildOrderName.CYCLONE_TANK_3RAX.value
    ...
    def __init__(self, bot: BotAI):
        ...
        self.steps = [
            ...
            BuildOrderStep(bot, self, 'gas #2', UnitTypeId.REFINERY, target_count=2, workers=18),
            ...
            BuildOrderStep(bot, self, 'rax #2/3', UnitTypeId.BARRACKS, target_count=3, requirements=[(UnitTypeId.FACTORYTECHLAB, 1, False)]),
            BuildOrderStep(bot, self, '3rd CC', UnitTypeId.COMMANDCENTER, target_count=3, requirements=[(UnitTypeId.BARRACKS, 3, False)]),
            BuildOrderStep(bot, self, 'rax techlab #2', UnitTypeId.BARRACKSTECHLAB, target_count=2, townhalls=3),
            BuildOrderStep(bot, self, 'Starport', UnitTypeId.STARPORT, townhalls=3),
            BuildOrderStep(bot, self, 'Starport Reactor', UnitTypeId.STARPORTREACTOR),
