...
class DefensiveTwoRax(BuildOrder):
    ...
    def __init__(self, bot: Superbot):
        ...
        self.steps = [
            ...
            BuildOrderStep(bot, self, 'reactor', UnitTypeId.BARRACKSREACTOR, target_count=2, requirements=[(UnitTypeId.BARRACKS, 3, False)]),
            ...
            BuildOrderStep(bot, self, 'reactor #2 (from facto)', UnitTypeId.FACTORYREACTOR, target_count=3, requirements=[(UnitTypeId.STARPORT, 1, False)]),
