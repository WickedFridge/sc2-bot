...
class CCFirstTwoRax(BuildOrder):
    ...
    def __init__(self, bot: BotAI):
        super().__init__(bot)
        self.steps = [
            BuildOrderStep(bot, 'expand', UnitTypeId.COMMANDCENTER, target_count=2),
            ...
            BuildOrderStep(bot, 'stim', UpgradeId.STIMPACK, requirements=[(UnitTypeId.FACTORY, 1, False)]),
            ...
            BuildOrderStep(bot, '3rd CC', UnitTypeId.COMMANDCENTER, target_count=3, requirements=[(UnitTypeId.FACTORYREACTOR, 1, False)]),
        ]