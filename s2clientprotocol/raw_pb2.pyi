...
class Event(Message):
    dead_units: list[int]
    def __init__(self, dead_units: list[int] = ...) -> None: ...
...
class ActionRawToggleAutocast(Message):
    ability_id: int
    unit_tags: list[int]
    def __init__(self, ability_id: int = ..., unit_tags: list[int] = ...) -> None: ...
